...
# /mysite2/pybo/models/speaker_recognition/16000_pcm_speeches/random 에서 오디오 읽어옴
# The main folder directory
DATASET_ROOT =os.path.join("/Users/kian/Workspace/applied_2/speech/myapp/models/speaker_recognition/16000_pcm_speeches/" )
...
model = tf.keras.models.load_model("/Users/kian/Workspace/applied_2/speech/myapp/models/speaker_model.h5")
...
def test_model(input_data: str = speaker_text):
    ...
    loaded_model = spacy.load("/Users/kian/Workspace/applied_2/speech/myapp/models/model_artifacts")
    # Generate prediction
    ...
    with open('/Users/kian/Workspace/applied_2/speech/myapp/templates/test.html', 'w') as f:
        f.write(f"* Predicted speaker : {pred_speaker[0]}</br>")
        f.write(f"* Speaker text: {input_data}\n\n</br> * Predicted sentiment: {prediction},&nbsp&nbsp")
